...
import { MonthViewModel, DayViewModel } from '@ng-bootstrap/ng-bootstrap/datepicker/datepicker-view-model';
import { NgbDate, NgbDatepickerI18n } from '@ng-bootstrap/ng-bootstrap';

@Component({
  selector: 'cr-ngb-datepicker-month-view-copy',
  host: {'role': 'grid'},
...
export class NgbDatepickerMonthViewCopyComponent implements OnInit {
